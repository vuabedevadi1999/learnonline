...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link rel="stylesheet" href = "{{asset('front-end/fontawesome-free-5.15.1-web/css/fontawesome.min.css')}}"/>
    <link rel="stylesheet" href = "{{asset('front-end/fontawesome-free-5.15.1-web/css/all.min.css')}}"/>
    <!-- Styles -->
</head>
<body>
        ...
        <div id="sidebar" class="nav-collapse">
            ...
            <div class="leftside-navigation">
                <ul class="sidebar-menu" id="nav-accordion">
                    <li class="sub-menu">
                        <li><a href="{{URL::to('danh-sach-nguoi-dung')}}">Danh sách người dùng</a></li>
                        <li><a href="{{URL::to('danh-sach-lop-hoc')}}">Danh sách lớp học</a></li>
                        <li><a href="{{URL::to('danh-sach-cau-hoi')}}">Danh sách câu hỏi</a></li>
                        <li><a href="{{URL::to('list-lession')}}">Danh sách bài học</a></li>
                    </li>
                </ul>
            </div>
            <!-- sidebar menu end-->
