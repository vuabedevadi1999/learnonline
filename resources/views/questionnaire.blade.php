@extends('welcome')
@section('content')<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
...
<body>
<form class="jotform-form" action="{{URL::to('/check-answer/'.$id)}}" method="POST">
    {{ csrf_field()}}
            ...
            <li class="form-line" data-type="control_button" id="id_34">
                <div id="cid_34" class="form-input-wide" data-layout="full">
                    <div data-align="auto" class="form-buttons-wrapper form-buttons-auto jsTest-button-wrapperField">
                        <button style="background-color: blue" id="input_34" type="submit"
